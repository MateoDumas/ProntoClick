      ...
      <div className="flex gap-4 relative z-10">
        {product.image ? (
          <div className="relative group/image">
            ...
            <div className="hidden w-28 h-28 bg-gradient-to-br from-red-400 via-red-400 to-red-500 rounded-xl flex-shrink-0 flex items-center justify-center group-hover:scale-110 transition-transform duration-500 shadow-lg">
              <svg
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 mt-2 line-clamp-2 leading-relaxed group-hover:text-gray-700 dark:group-hover:text-gray-300 transition-colors">{product.description}</p>
