...
export const holidays: Record<HolidayType, HolidayTheme> = {
  ...
  christmas: {
    ...
    primaryColor: 'green',
    secondaryColor: 'red',
    gradient: 'from-green-700 via-red-600 to-green-600',
  ...
  newyear: {
    ...
    primaryColor: 'yellow',
    secondaryColor: 'blue',
    gradient: 'from-purple-600 via-blue-600 to-yellow-500',
  ...
  kings: {
    ...
    primaryColor: 'yellow',
    secondaryColor: 'purple',
    gradient: 'from-yellow-600 via-purple-600 to-yellow-600',
  ...
  easter: {
    ...
    gradient: 'from-pink-600 via-purple-500 to-blue-600',
