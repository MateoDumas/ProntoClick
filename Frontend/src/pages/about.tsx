        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <section className="bg-white dark:bg-gray-800 rounded-2xl p-8 md:p-12 mb-8 shadow-lg border border-gray-200 dark:border-gray-700 transition-colors duration-200">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                <div className="w-16 h-16 bg-gradient-to-br from-red-500 to-red-600 dark:from-red-600 dark:to-red-700 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-3xl">⚡</span>
                </div>
                <h3 className="font-bold text-gray-900 dark:text-gray-100 mb-2">Rapidez</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="font-bold text-gray-900 dark:text-gray-100 mb-2">Calidad</h3>
                <p className="text-gray-600 dark:text-gray-300 text-sm">
              ...
              <div className="text-center">
                ...
                <h3 className="font-bold text-gray-900 dark:text-gray-100 mb-2">Compromiso</h3>
                <p className="text-gray-600 dark:text-gray-300 text-sm">
          ...
          <section className="bg-white dark:bg-gray-800 rounded-2xl p-8 md:p-12 mb-8 shadow-lg border border-gray-200 dark:border-gray-700 transition-colors duration-200">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">Amplia variedad</h3>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">Sistema de puntos</h3>
                  <p className="text-gray-600 dark:text-gray-300">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">Promociones diarias</h3>
                  <p className="text-gray-600 dark:text-gray-300">
          ...
          <section className="bg-gradient-to-r from-red-600 to-red-700 dark:from-red-700 dark:to-red-800 rounded-2xl p-8 md:p-12 text-white text-center transition-colors duration-200">
            ...
            <div className="flex gap-4 justify-center">
              ...
              <a
                href="/restaurants"
                className="px-8 py-3 bg-red-800 dark:bg-red-900 text-white font-semibold rounded-lg hover:bg-red-900 dark:hover:bg-red-950 transition-colors border border-red-500 dark:border-red-700"
              >
                Ver Restaurantes
              </a>
            </div>
