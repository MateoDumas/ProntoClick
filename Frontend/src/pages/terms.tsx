  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-red-50 py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-2xl p-8 md:p-12 shadow-lg border border-gray-200 space-y-8">
            {/* Section 1 */}
            <section>
            ...
            {/* Section 5 */}
            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">5. Sistema de ProntoPuntos</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <section>
              ...
              <div className="mt-4 space-y-2">
                <p className="text-gray-700">
                  <strong>Email:</strong> <a href="mailto:legal@prontoclick.com" className="text-red-600 hover:underline">legal@prontoclick.com</a>
                </p>
                <p className="text-gray-700">
                  <strong>Teléfono:</strong> <a href="tel:+15551234567" className="text-red-600 hover:underline">+1 (555) 123-4567</a>
                </p>
              </div>
            </section>
          </div>
