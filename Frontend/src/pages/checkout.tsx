                  ...
                  <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                    <div className="grid grid-cols-3 gap-4 text-sm">
                      <div>
                        ...
                        <p className="font-semibold text-gray-900">{formatDistance(deliveryInfo.distance)}</p>
                      </div>
                      <div>
                        <p className="text-gray-600">Tiempo estimado</p>
                        <p className="font-semibold text-gray-900">{formatDeliveryTime(deliveryInfo.time)}</p>
                      </div>
                      <div>
                        <p className="text-gray-600">Costo de envío</p>
                        <p className="font-semibold text-red-600">${deliveryInfo.fee.toFixed(2)}</p>
                      </div>
                    </div>
                  </div>
                )}
