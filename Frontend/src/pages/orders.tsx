...
export default function Orders() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 min-h-screen">
      ...
      {orders.length === 0 ? (
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 sm:p-12 text-center transition-colors duration-200">
          <svg
          ...
          <Link href="/">
            <button className="px-6 py-3 bg-blue-600 dark:bg-blue-500 text-white text-sm sm:text-base font-semibold rounded-lg hover:bg-blue-700 dark:hover:bg-blue-600 transition-colors w-full sm:w-auto">
        ...
        <div className="space-y-4">
          {orders.map((order) => (
            <Link
              ...
              className="block bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4 sm:p-6 hover:shadow-lg dark:hover:shadow-xl dark:hover:shadow-black/20 transition-all hover:border-blue-300 dark:hover:border-blue-600"
            >
              <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                <div className="flex-1 min-w-0">
                  <div className="flex flex-wrap items-center gap-2 sm:gap-3 mb-3">
                    ...
                    <span
                      className={`px-2 sm:px-3 py-1 rounded-full text-xs font-semibold whitespace-nowrap ${statusColors[order.status]}`}
                    >
                ...
                <div className="flex items-center justify-between sm:ml-4 sm:justify-end">
